...
export default function VerifyEmailTemplate({ validationCode }: Props) {
  return (
    <Html>
      <Head>
        <style>
      ...
      <Preview>Autorización y Verificación de Identidad</Preview>
        ...
        <Container style={{ backgroundColor: '#FFFFFF', margin: '0 auto', padding: '0', maxWidth: '100%', overflow: 'hidden' }}>
          ...
          <Section style={{ padding: '40px 40px 20px' }}>
            ...
            <Text style={{ fontSize: '16px', color: '#52525B', lineHeight: '28px', margin: '0 0 36px', fontWeight: '300' }}>
              Para asegurar la integridad de su información y dar curso a su solicitud, requerimos validar su identidad ingresando la siguiente clave de acceso en la plataforma:
            </Text>
            ...
            <Text style={{ fontSize: '14px', color: '#71717A', lineHeight: '24px', margin: '0 0 32px', fontWeight: '300' }}>
              Esta clave de acceso es estrictamente confidencial y caducará en <strong style={{ color: '#18181B', fontWeight: '500' }}>15 minutos</strong>.
            </Text>
          </Section>
